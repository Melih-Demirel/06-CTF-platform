<template>
    ...
    <div class="container-fluid h-75 d-flex flex-column align-items-center justify-content-center" v-if="loaded">
        ...
        <div class="d-flex flex-row justify-content-between w-75 mt-4 mb-2">
            ...
            <div class="dropdown">
                <h1 class="dropdown-toggle fw-bolder" id="dropdownMenuButton" data-bs-toggle="dropdown" data-bs-target="#firstDropdown" aria-expanded="false">
                    {{ activeCategory }}
                </h1>
                <ul class="dropdown-menu w-100" id="firstDropdown" aria-labelledby="dropdownMenuButton">
            ...
            <div class="dropdown">
                <h1 class="fs-4 mt-2" data-bs-toggle="dropdown" data-bs-target="#secondDropdown" aria-expanded="false"> 
                    FILTER
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-filter" viewBox="0 0 16 16">
                    <path d="M6 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/>
                    </svg>
                </h1>
                <ul class="dropdown-menu" id="secondDropdown">
