...
export default defineComponent ({
    ...
    setup () {
        ...
        const onNextStep = () => {currentStep.value = (currentStep.value + 1) % (maxSteps+1); console.log(currentStep.value);}
        ...
        const onCreateChallenge = async () => {
            try {
                ...
                if( newChallenge.value.Points! < 0){return toast.error("Negative points!")}
